...
public class F5DetectRollingCountBolt extends BaseRichBolt {
	...
	private static final Logger LOG = Logger
			.getLogger(F5DetectRollingCountBolt.class);
	...
	public F5DetectRollingCountBolt() {
		this(DEFAULT_SLIDING_WINDOW_IN_SECONDS,
				DEFAULT_EMIT_FREQUENCY_IN_SECONDS);
	}

	public F5DetectRollingCountBolt(int windowLengthInSeconds,
